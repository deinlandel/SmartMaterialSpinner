...
/**
 * Copy of standard android ArrayAdapter except it supports "contains" (not just "starts with") filtering.
 * Had to do this because of how poorly ArrayAdapter is designed (impossible to set your own filter)
 */
public class ContainsArrayAdapter<T> extends BaseAdapter implements Filterable, SpinnerAdapter {
    /**
     ...
     */
    public ContainsArrayAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull T[] objects) {
     ...
     * @param objects The objects to represent in the ListView.
     */
    public ContainsArrayAdapter(@NonNull Context context, @LayoutRes int resource,
    ...
    private ContainsArrayAdapter(@NonNull Context context, @LayoutRes int resource,
    ...
    ContainsArrayAdapter<CharSequence> createFromResource(@NonNull Context context,
                                                          @ArrayRes int textArrayResId, @LayoutRes int textViewResId) {
        final CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new ContainsArrayAdapter<>(context, textViewResId, 0, Arrays.asList(strings), true);
    }
     ...
     * a search string. Each item that does not conatins the supplied search string
    ...
    private class ArrayFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence search) {
            ...
            if (search == null || search.length() == 0) {
                ...
                final String prefixString = search.toString().toLowerCase();
